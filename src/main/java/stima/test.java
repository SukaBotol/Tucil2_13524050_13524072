...
public class test{
    ...
    public static class Tree{
        ...
        public void split_cube(Node root, int depth, int max_depth){
            ...
            // 0
            vertex tempMax = new vertex(root.surrounding[0].x+currentLen/2,root.surrounding[0].y+currentLen/2,root.surrounding[0].z), 
            tempMin = new vertex(root.surrounding[0].x,root.surrounding[0].y,root.surrounding[0].z-currentLen/2);
            ...
            tempMin = new vertex(root.surrounding[1].x-currentLen/2,root.surrounding[1].y,root.surrounding[1].z-currentLen/2);
            temp = new Node(starting_cube(tempMax, tempMin), root);
            root.children[1]=temp;

            // 2
            tempMax = new vertex(root.surrounding[2].x,root.surrounding[2].y+currentLen/2,root.surrounding[2].z+currentLen/2);
            tempMin = new vertex(root.surrounding[2].x-currentLen/2,root.surrounding[2].y,root.surrounding[2].z);
            temp = new Node(starting_cube(tempMax, tempMin), root);
            root.children[2]=temp;

            // 3
            tempMax = new vertex(root.surrounding[3].x+currentLen/2,root.surrounding[3].y+currentLen/2,root.surrounding[3].z+currentLen/2);
            ...
            tempMin = new vertex(root.surrounding[4].x,root.surrounding[4].y-currentLen/2,root.surrounding[4].z-currentLen/2);
            temp = new Node(starting_cube(tempMax, tempMin), root);
            root.children[4]=temp;

            // 5
            tempMax = new vertex(root.surrounding[5].x,root.surrounding[5].y,root.surrounding[5].z);
            tempMin = new vertex(root.surrounding[5].x-currentLen/2,root.surrounding[5].y-currentLen/2,root.surrounding[5].z-currentLen/2);
            temp = new Node(starting_cube(tempMax, tempMin), root);
            root.children[5]=temp;

            // 6
            tempMax = new vertex(root.surrounding[6].x,root.surrounding[6].y,root.surrounding[6].z+currentLen/2);
            tempMin = new vertex(root.surrounding[6].x-currentLen/2,root.surrounding[6].y-currentLen/2,root.surrounding[6].z);
            temp = new Node(starting_cube(tempMax, tempMin), root);
            root.children[6]=temp;

            // 7
            tempMax = new vertex(root.surrounding[7].x+currentLen/2,root.surrounding[7].y,root.surrounding[7].z+currentLen/2);
            ...
            // for(int i=0;i<8;i++){
            //     System.out.println("num_"+i+":\n"+"x: "+root.children[0].surrounding[i].x+"\ny: "+root.children[0].surrounding[i].y+"\nz: "+root.children[0].surrounding[i].z+"\n");
            // }
        ...
        public static void build_cubes(String fileDest, Node node){
            if(is_leaf(node)){
                if(node.isActive){
                    ...
                    for(int i=0;i<8;i++){
                        temp.append("v "+node.surrounding[i].x+" "+node.surrounding[i].y+" "+node.surrounding[i].z+"\n");
                    }
                    temp.append("f "+(verticesCount+3)+" "+(verticesCount+2)+" "+(verticesCount+1)+" "+verticesCount+"\n");
                    temp.append("f "+verticesCount+" "+(verticesCount+1)+" "+(verticesCount+5)+" "+(verticesCount+4)+"\n");
                    temp.append("f "+verticesCount+" "+(verticesCount+4)+" "+(verticesCount+7)+" "+(verticesCount+3)+"\n");
                    temp.append("f "+(verticesCount+1)+" "+(verticesCount+2)+" "+(verticesCount+6)+" "+(verticesCount+5)+"\n");
                    temp.append("f "+(verticesCount+2)+" "+(verticesCount+3)+" "+(verticesCount+7)+" "+(verticesCount+6)+"\n");
                    temp.append("f "+(verticesCount+4)+" "+(verticesCount+5)+" "+(verticesCount+6)+" "+(verticesCount+7)+"\n");
    ...
    public static void main(String[] args) throws Exception{
        ...
        // System.out.println("starting cube 1.0: "+ocTree.root.children[0].isActive);
        // System.out.println("starting cube 1.1: "+ocTree.root.children[1].isActive);
        // System.out.println("starting cube 1.2: "+ocTree.root.children[2].isActive);
        // System.out.println("starting cube 1.3: "+ocTree.root.children[3].isActive);
        // System.out.println("starting cube 1.4: "+ocTree.root.children[4].isActive);
        // System.out.println("starting cube 1.5: "+ocTree.root.children[5].isActive);
        // System.out.println("starting cube 1.6: "+ocTree.root.children[6].isActive);
        // System.out.println("starting cube 1.7: "+ocTree.root.children[7].isActive);
